...
public class Strafe
{
    ...
    public Vector2 UpdateFromTilting(Quaternion tiltOffSet)
    {
        ...
        _lerp.x = Mathf.Clamp(_lerp.x, -1f, 1f);//ограничение используетс€ дл€ блокировки бага с исчезновением "точки" при калибровке если телефон был наклонен под определенными углами.
